...
```js
npm install --save redux-promise-bluebird
```

This package works identically to redux-promise, it just implements the [bluebird](https://github.com/petkaantonov/bluebird) promise library over-top of the build-in promise library. This allows for older versions of IE to be supported (older browsers do not typically support the native Promise library)
